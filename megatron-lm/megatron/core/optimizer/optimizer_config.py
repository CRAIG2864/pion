...
class OptimizerConfig:
    ...
    """The Newton-Schulz coefficient type for Muon/Pion msign optimizers."""
    ...
    pion_lr: Optional[float] = None
    """Independent max learning rate for Pion matrix parameters. None falls back to lr."""

    pion_min_lr: Optional[float] = None
    """Independent min learning rate for Pion matrix parameters. None falls back to min_lr."""
    ...
    """Step-size multiplier for Pion msign orthogonal exponential updates."""
